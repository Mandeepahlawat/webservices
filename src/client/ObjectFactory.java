...
public class ObjectFactory {
    ...
    private final static QName _CreateTRecordResponse_QNAME = new QName("http://server/", "createTRecordResponse");
    private final static QName _CreateTRecord_QNAME = new QName("http://server/", "createTRecord");
    ...
    private final static QName _CreateSRecord_QNAME = new QName("http://server/", "createSRecord");
    ...
    private final static QName _CreateSRecordResponse_QNAME = new QName("http://server/", "createSRecordResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "createTRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "createTRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "createSRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "createSRecordResponse")
